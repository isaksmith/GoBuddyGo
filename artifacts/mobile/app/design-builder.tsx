  ...
  if (isScannedType && !effectiveModelUrl) {
    return (
      <View style={[previewStyles.container, containerSize, { backgroundColor: "#09192A", borderRadius, alignItems: "center", justifyContent: "center", gap: 10 }]}>
        ...
        {size === "large" && (
          <Text style={{ color: "#8ca0b5", fontSize: 12, fontFamily: "BalsamiqSans_700Bold", letterSpacing: 1 }}>
            GENERATING 3D MODEL...
          </Text>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  headerCenter: { flex: 1 },
  headerTitle: { color: Colors.text, fontSize: 20, fontFamily: "BalsamiqSans_700Bold", letterSpacing: 1.5 },
  headerSub: { color: Colors.accent, fontSize: 10, fontFamily: "BalsamiqSans_700Bold", letterSpacing: 1.5, marginTop: 2 },
  previewSection: {
    alignItems: "center",
    marginBottom: 28,
    gap: 12,
