...
const styles = StyleSheet.create({
  ...
  notFoundText: { color: Colors.text, fontSize: 18, fontFamily: "Quicksand_700Bold" },
  backBtnAlt: { backgroundColor: Colors.primary, borderRadius: 50, paddingVertical: 12, paddingHorizontal: 24 },
  backBtnAltText: { color: "#FFFFFF", fontSize: 14, fontFamily: "Quicksand_700Bold" },
  ...
  headerCenter: { flex: 1 },
  headerTitle: { color: Colors.text, fontSize: 22, fontFamily: "Quicksand_700Bold", letterSpacing: 2 },
  headerSub: { color: Colors.accent, fontSize: 10, fontFamily: "Quicksand_700Bold", letterSpacing: 1, marginTop: 1 },
  ...
  nameText: { color: Colors.secondary, fontSize: 14, fontFamily: "Quicksand_700Bold", letterSpacing: 1 },
  ...
  nameInput: {
    ...
    fontSize: 15, fontFamily: "Quicksand_700Bold", borderWidth: 2, borderColor: Colors.secondary,
  },
  nameSaveBtn: {
  ...
  stickerHintText: { color: "rgba(255,255,255,0.5)", fontSize: 13, fontFamily: "Quicksand_700Bold", letterSpacing: 1.5 },
  ...
  addStickerBtnText: { color: "#FFFFFF", fontSize: 15, fontFamily: "Quicksand_700Bold", letterSpacing: 1.5 },
  ...
  stickerCountText: { color: Colors.accent, fontSize: 11, fontFamily: "Quicksand_700Bold", letterSpacing: 0.5 },
  helpRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 14 },
  helpText: { color: Colors.textMuted, fontSize: 11, fontFamily: "Quicksand_700Bold", letterSpacing: 0.5 },
  ...
  convert3dBtnText: { color: "#FFFFFF", fontSize: 17, fontFamily: "Quicksand_700Bold", letterSpacing: 1.5 },
  errorRow: { flexDirection: "row", alignItems: "center", gap: 6, marginBottom: 10 },
  errorText: { color: Colors.danger, fontSize: 12, fontFamily: "Quicksand_700Bold", letterSpacing: 0.5 },
  ...
  pendingTitle: { color: Colors.text, fontSize: 15, fontFamily: "Quicksand_700Bold", letterSpacing: 1.5, textAlign: "center" },
  pendingSubtitle: { color: Colors.textSecondary, fontSize: 12, fontFamily: "Quicksand_400Regular", textAlign: "center" },
  ...
  view3dBtnText: { color: "#FFFFFF", fontSize: 17, fontFamily: "Quicksand_700Bold", letterSpacing: 1.5 },
  regenerateRow: { flexDirection: "row", alignItems: "center", gap: 5, alignSelf: "center", marginBottom: 16 },
  regenerateText: { color: Colors.textMuted, fontSize: 10, fontFamily: "Quicksand_700Bold", letterSpacing: 1 },
  model3dHint: { position: "absolute", bottom: 8, left: 0, right: 0, alignItems: "center" },
  model3dHintText: { color: "rgba(255,255,255,0.45)", fontSize: 10, fontFamily: "Quicksand_700Bold", letterSpacing: 1.2 },
  stickerCatalog: { marginTop: 4 },
  catalogTitle: { color: Colors.textSecondary, fontSize: 11, fontFamily: "Quicksand_700Bold", letterSpacing: 2, marginBottom: 12 },
  ...
  viewerTitle: { color: Colors.text, fontSize: 18, fontFamily: "Quicksand_700Bold", letterSpacing: 2 },
  ...
  viewerHint: { color: Colors.textMuted, fontSize: 11, fontFamily: "Quicksand_700Bold", letterSpacing: 1 },
});
